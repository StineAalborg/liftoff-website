...
<body>
  ...
  <div class="splash-screen">
    <img class="splash-plane" src="img/splash/plane.svg" />
    <img class="splash-logo" src="img/splash/liftoff.svg" />
  </div>
    ...
    <section id="location">
      ...
      <div class="google-maps">
        <div class="maps-background">
          <div id="map">
            <!-- Google maps API will fill in contet, here -->
          </div>
        </div>
      </div>
    </section>
        ...
        <form class="contact-form" action="contact.php" method="post">
          ...
          <div class="row name">
            ...
            <div class="input-wrap">
              <input type="text" name="name" placeholder="Maverick" required/>
            </div>
          </div>
          <div class="row email">
            <label for="">E-mail</label>
            <div class="input-wrap">
              <input type="email" name="email" placeholder="Maverick@top.gun" required/>
            </div>
          </div>
          <div class="row phone">
  ...
  <a class="secret-konami-unicorn-of-doom">
    <!-- ¡¡¡Unlock the secrets of the magical konami-unicorn!!! -->
  </a>
